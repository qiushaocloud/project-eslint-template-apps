...
const copyFilePaths = [
    [path.resolve(__dirname, '../build-after-file/package.json'), path.resolve(__dirname, '../webpack-result'), 'package.json'],
    [path.resolve(__dirname, '../build-after-file/README.md'), path.resolve(__dirname, '../webpack-result'), 'README.md'],
    [path.resolve(__dirname, '../build-after-file/main.d.ts'), path.resolve(__dirname, '../webpack-result'), 'main.d.ts']
];
